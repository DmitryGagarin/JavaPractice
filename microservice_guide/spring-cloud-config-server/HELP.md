...
* The original package name 'microservice.example.spring-cloud-config-server' is invalid and this project uses 'microservice.example.spring_cloud_config_server' instead.
